								...
								<div class="info info-horizontal">
									<?php if ( ! empty( $contact_item->icon_value ) ) : ?>
										<div class="icon icon-primary">
											<i class="fa <?php echo esc_attr( $contact_item->icon_value ); ?>"></i>
										</div>
									<?php endif; ?>
									<div class="description">
										<?php if ( ! empty( $contact_item->title ) ) : ?>
											<h4 class="info-title"><?php echo wp_kses_post( $contact_item->title ); ?></h4>
										<?php endif; ?>
										<?php if ( ! empty( $contact_item->text ) ) : ?>
											<p><?php echo wp_kses_post( $contact_item->text ); ?></p>
										<?php endif; ?>
									</div>
								</div>
								<?php
